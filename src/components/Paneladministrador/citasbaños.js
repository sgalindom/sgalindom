      ...
      if (usuarioEmail) {
        ...
        if (vetNameSnapshot.exists) {
          ...
          const citasSnapshot = await firestore()
            .collection(`Administradores/${usuarioEmail}/citasbaños`)
    ...
    try {
      ...
      if (vetNameSnapshot.exists) {
        ...
        if (citaData.exists) {
          ...
          // Añade la cita a la colección de Citas Baños Atendidas
          await firestore()
