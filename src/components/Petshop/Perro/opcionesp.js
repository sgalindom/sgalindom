...
const Opcionesp = ({ route, navigation }) => {
    ...
    const obtenerOpciones = async (tarjeta) => {
      try {
        ...
        switch (tarjeta) {
          case 'Alimento':
            imageUrls = [
              { nombre: 'Humedo', tipoColeccion: tarjeta, imagenRef: 'perro/humedoperros.jpg' },
              { nombre: 'Concentrado', tipoColeccion: tarjeta, imagenRef: 'perro/alimentoconcentradoperros.jpg' },
            ];
            break;
          case 'Snacks':
            imageUrls = [
        ...
        {loading ? (
          ...
          opciones.map((opcion, index) => (
            <TouchableOpacity
              ...
              onPress={() => navigation.navigate('verproductosp', { tipoColeccion: opcion.tipoColeccion, tipoAlimento: opcion.nombre })}
            >
              <Image
